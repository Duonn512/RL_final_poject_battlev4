...
from torch_model import QNetwork as redQN
from final_torch_model import QNetwork as final_redQN
...
def eval():
    ...
    print(
        run_eval(
            ...
            blue_policy=blue_policy, # Change this to the blue policy
            n_episode=30
        )
    )
    print("=" * 20)
